...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="student/student_dashboard.php" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="student/student_dashboard.php" class="d-block">你好,
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item <?php echo $student_drop_menu ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./student/student_profile.php"
                                        class="nav-link <?php echo $student_profile_menu ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>你的信息</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./student/student_course.php"
                                        class="nav-link <?php echo $student_course ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>你的课程</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./student/student_all_course.php"
                                        class="nav-link <?php echo $student_all_course_menu ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>所有课程</p>
                                    </a>
                                </li>
