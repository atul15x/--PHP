...
$student_menu = "active";
$student_all_course_menu = "active";
...
$profile = "SELECT *, course.id as cid FROM course INNER JOIN department ON course.c_depart_id  = department.id
            INNER JOIN teacher_user ON course.c_teacher_id = teacher_user.id WHERE 	c_depart_id = $checkDepartment  ";
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($profile_query)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="button" onclick="coursePick(<?= $row['cid']; ?>)"
                                        class="btn btn-info btn-sm ">选择</a>
                                </td>
                            </tr>
                            <?php
                        }
