...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="teacher/teacher_dashboard.php" class="brand-link">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="teacher/teacher_dashboard.php" class="d-block">你好,
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item <?php echo $teacher_drop_menu ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./teacher/teacher_profile.php"
                                        class="nav-link <?php echo $teacher_profile_menu ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>你的信息</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./teacher/teacher_course.php"
                                        class="nav-link <?php echo $teacher_course ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>你的课程</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="./teacher/teacher_all_course.php"
                                        class="nav-link <?php echo $teacher_all_course_menu ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>所有课程</p>
                                    </a>
                                </li>
